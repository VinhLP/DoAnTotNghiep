...
public class BanAnDAO  {
    ...
    public boolean CapNhatLaiTenBan(int maban, String tinhtrang){
        ContentValues contentValues = new ContentValues();
        contentValues.put(CreateDatabase.TB_BANAN_TENBAN, tinhtrang);
    ...
    public BanAnDTO LayDanhSachBanAnTheoMa(int maban){
        BanAnDTO banAnDTO = new BanAnDTO();
